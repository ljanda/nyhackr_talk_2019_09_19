...
theme_diamonds <- function(x) {
  theme(text = element_text(family = "Luminari"),
        axis.text = element_text(size = 12, color = "skyblue"),
        axis.title.x = element_text(size = 14, color = "skyblue", vjust = -3),
        axis.title.y = element_text(size = 14, color = "skyblue", vjust = 6),
        axis.line.x = element_line(color  = "gold"), 
        axis.line.y = element_line(color  = "gold"), 
        axis.ticks = element_line(color  = "gold"),
        plot.title = element_text(size = 16, face = "bold", color = "skyblue"),
...
```{r use_theme_diamonds, echo=FALSE, fig.width=7, fig.height=5}
ggplot(diamonds, aes(factor(cut), price)) + 
  geom_boxplot() +
  labs(title = "Diamond Prices By Cut") +
  theme_diamonds()
...
```{r ridgeplot, echo=TRUE, message=FALSE, fig.width=7, fig.asp=0.618}
...
ggplot(diamonds, aes(price, cut)) + 
  ggridges::geom_density_ridges(scale = 1.4, rel_min_height = 0.001, 
                                alpha = 0.5,
...
ggplot(diamonds, aes(price, cut, fill = ..x..)) + 
  ggridges::geom_density_ridges_gradient(scale = 1.4, 
...
ggplot(diamonds, aes(price, cut, fill = factor(..quantile..))) + 
  ggridges::stat_density_ridges(scale = 1.4, rel_min_height = 0.001, 
...
```{r raincloud, echo=TRUE, message=FALSE, fig.width=8, fig.asp=0.618}
...
- [Shiny app: tidytuesday.rocks](https://nsgrantham.shinyapps.io/tidytuesdayrocks/)
...
```{r simpsons2, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=7}
...
```{r got2, fig.width=7, fig.height=5}
...
sim_data_pre_post %>% 
  ...
  scale_fill_manual("Score Level",
                    values = c("1" = "#4d5050", "2" = "#c2c5c6", 
                               "3" = "#f2ac80", "4" = "#F37321")) +
  labs(x = "") +
  facet_wrap(~unit_title, scales = "free_y") +   # let y scale vary by facet
  theme_minimal() + 
  theme(panel.border = element_blank(), 
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), 
...
```{r ggalluvial2, echo=FALSE, fig.width=12, fig.asp=0.618}
...
job_outcomes %>% 
  ...
  geom_alluvium(aes(fill = final_outcome), color = "darkgrey", na.rm = TRUE) +
  geom_stratum(na.rm = TRUE) +
  geom_text(stat = "stratum", na.rm = TRUE, size = 4) + 
  theme_minimal() + 
...
https://twitter.com/lpmkremer/status/1168912680767447040?s=21
...
Use Slack to help make your own color pallettes:
  https://twitter.com/ludmila_janda/status/1166078113719230464
