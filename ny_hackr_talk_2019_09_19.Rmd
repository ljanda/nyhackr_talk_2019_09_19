...
```{r ridgeplotj, echo=TRUE, message=FALSE, fig.width=4.5, fig.asp=0.618, cache=TRUE}
ggplot(diamonds, aes(price, cut)) + 
...
ggplot(GOT_pets, aes(fct_infreq(animals_name), fill = species)) + 
  ...
  theme(text = element_text(size = 8, family = "Cinzel"))
```
...
- Use fun ggplot adjacent packages
